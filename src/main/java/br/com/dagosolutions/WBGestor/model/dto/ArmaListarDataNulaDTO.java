...
public class ArmaListarDataNulaDTO extends ArmaListarNaoNulosDTO {

    public ArmaListarDataNulaDTO(Arma arma) {
        super(arma.getId(), arma.getSerie(), arma.getCor(), arma.getDataEntrada(),
                arma.getStatus(),arma.getModeloArma().getModelo(),arma.getCliente().getNome());
    }
}
